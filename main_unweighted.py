...
def main_unweighted(df: pd.DataFrame):
    """
       Performs an interactive exploratory data analysis (EDA) on an unweighted dataset using Streamlit.
       ...
       2. Column Highlights:
          - Detects and displays key column properties, including high correlations, missing values, and standard deviations.

       3. Detailed Column Analysis:
          - Allows users to view detailed statistics (e.g., mean, median, percentiles) for selected or all columns.
          - Includes visualizations such as histograms, box plots, scatterplots, and bar plots.
